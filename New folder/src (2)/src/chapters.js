                ...
                <div className="row">
                    <div className="col-12 circleChapter">
                        ...
                        <div className="textChapter">
                            ...
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam animi corporis
                            culpa, <br/>
                        ...
                        <div className="col-12 ">
                            <div className="ChapterBox">
                                ...
                                <div className="ChapterBtn">
                                    <img className={'pointer'} onClick={() => getCourseChapter(item.id)}
                                         src="/Chapter1.png" alt=""/>
                                </div>
                            </div>
                                        ...
                                        <div className="row d-flex">
                                            {courseLesson.map((item, index) => {
                                                return <div onClick={() => completeLesson(item.id)}
                                                            className={item.is_open ? "col-4 " : "col-4  disableddd"}>
